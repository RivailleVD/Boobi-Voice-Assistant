...
def avançar():
    '''Função para avançar o video no youtube'''
...
def retroceder():
    '''Função para retroceder o video no youtube'''
...
def pausa():
    '''Função para pausar o video no youtube'''
...
def reproduzir():
    '''Função para reproduzir o video pausado no youtube'''
